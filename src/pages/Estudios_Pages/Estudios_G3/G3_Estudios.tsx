            ...
            >
                {(styles) => <div style={styles}>
                    ...
                    <Paper
                        ...
                        <Center>
                            <Title order={3}>Funcionamiento de Vehiculo</Title>
                        </Center>
                        <Divider my="md" size="lg" />
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Text>Como funciona un vehiculo?</Text>
                        ...
                        <Divider my="md" size="lg" />
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Text>Luces de un Vehiculo</Text>
