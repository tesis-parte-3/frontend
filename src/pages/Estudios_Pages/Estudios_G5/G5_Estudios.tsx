            ...
            >
                {(styles) => <div style={styles}>
                    ...
                    <Paper
                        ...
                        <Center>
                            <Title ta="center" order={3}>Vehiculos pesados/Transporte Publico</Title>
                        </Center>
                        <Divider my="md" size="lg" />
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Text>Guia Seleccion de Transporte Publico</Text>
                            <Link to="/Guia_Seleccion_Transporte_Publico">
                        ...
                        <Divider my="md" size="lg" />
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Text>Operadores de camiones</Text>
                            <Link to="/Operadores_de_camiones">
                                <Button variant="gradient"
                                    gradient={{ from: 'blue', to: 'cyan', deg: 90 }}>Leer</Button>
                            </Link>
                        </div>
                        ...
                        <Divider my="md" size="lg" />
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Text>Manejo seguro para camiones de carga</Text>
                            <Link to="/Manejo_para_camiones_de_carga">
                                <Button variant="gradient"
                                    gradient={{ from: 'blue', to: 'cyan', deg: 90 }}>Leer</Button>
                            </Link>
                        </div>
                    ...
                    <Paper
                        ...
                        <Center>
                            <Title order={3}>Normativa Grado 3</Title>
                        </Center>
                        <Divider my="md" size="lg" />
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
